...
export default class Carousel extends Component<CarouselProps, any> {
  ...
  // 移动到指定编号
  onMoveTo = (index:any, animationDuration:any) => {
  ...
  // 执行过渡动画
  doTransition = (offset:any, animationDuration:any) => {
    const dom = this.carouselItems;
    let x = 0;
    let y = 0;
  ...
  renderPaginationItem = (_result:any, index:any) => {
