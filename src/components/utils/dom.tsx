// import { ContainerType } from '../popup/PopupProps';
...
const domUtil = {
  ...
  // 获取元素css的某一个计算后属性值
  getStyleComputedProperty: (ele:any, property: any):string => {
    interface css {
  ...
  // 获取浏览器支持的带前缀属性名
  getSupportedPropertyName: (property:any) => {
