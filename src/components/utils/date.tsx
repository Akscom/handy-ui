export default {
  ...
  // 获取时间差的月份数
  getMonthCount(date1:any, date2:any) {
  ...
  // 两个日期是否同一个月
  isOneMonth(date1:any, date2:any) {
    if (!date1 || !date2) { return false; }
    const tmp1 = this.parseDate(date1);
    const tmp2 = this.parseDate(date2);
  ...
  // 克隆日期
  cloneDate(date:any, type?:any, during?:any) {
