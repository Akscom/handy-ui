...
export default {
  on(el:any, type:any, callback:any, options = { passive: false }) {
  ...
  off(el:any, type:any, callback:any, options = { passive: false }) {
  ...
  once(el:any, type:any, callback:any, options = { passive: false }) {
